...
."C:\Program Files (x86)\Windows Kits\10\bin\10.0.22000.0\x64\makecert" -r -pe -n "CN=Fany Test Certificate - For Internal Win32WebviewTemplate Use Only" -ss PrivateCertStore Win32WebviewTemplate.cer

."C:\Program Files (x86)\Windows Kits\10\bin\10.0.22000.0\x64\certmgr.exe" -add Win32WebviewTemplate.cer -s -r localMachine root
